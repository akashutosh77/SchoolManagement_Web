...
// import { IAttendanceProps } from "store/slices/ISlices";
...
//   const [attendanceStatusMap, setAttendanceStatusMap] = useState<Record<number, Idrpdown>>({});
...
//             handleAttendanceStatusChange(event, newValue, row.original.studentId!)
//           }
//           size="small"
